...
namespace Autopark.API.Migrations
{
    ...
    [Migration("20241115175840_VehicleMileageReport")]
    partial class VehicleMileageReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autopark.API.Entities.GpsPoint", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Autopark.API.Entities.Trip", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Autopark.API.Entities.VehicleMileageReport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("VehicleMileageReports", "identity");
                });
            ...
            modelBuilder.Entity("Autopark.API.Entities.GpsPoint", b =>
                {
                    b.HasOne("Autopark.API.Entities.Vehicle", "Vehicle")
                        .WithMany()
